document.addEventListener('DOMContentLoaded', async () => {
    ...
    const GAS_WEB_APP_URL = 'https://script.google.com/macros/s/AKfycbwHzF2dNQulVG2auCdINzAZ3kOHlV4rAK20MMdjtBtTOnVzyOpIJIDPfN4cDu5iejrY/exec'; // ERSTATT DENNE HVIS DU HAR EN NYERE URL
